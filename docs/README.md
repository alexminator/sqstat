...
## Installation
   ...
   3. Edit your squid.conf to allow cachemgr protocol:
      ...
      http_access deny manager</code></pre>

   5. Point your browser to sqstat.php file and see what happens :)
   6. (optionally) enable ip resolving in config.inc.php. Also you can make 
